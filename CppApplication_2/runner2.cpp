...
CxxTest::StaticSuiteDescription suiteDescription_same_elementsTest( "same_elementsTest.h", 21, "same_elementsTest", suite_same_elementsTest, Tests_same_elementsTest );

static class TestDescription_same_elementsTest_testMyFunction : public CxxTest::RealTestDescription {
public:
 TestDescription_same_elementsTest_testMyFunction() : CxxTest::RealTestDescription( Tests_same_elementsTest, suiteDescription_same_elementsTest, 27, "testMyFunction" ) {}

...
OBJECTFILES= \
	...
	${OBJECTDIR}/German_Address.o \
	${OBJECTDIR}/Person.o \
	${OBJECTDIR}/Student.o \
	${OBJECTDIR}/Student_Worker.o \
	${OBJECTDIR}/US_Address.o
...
${OBJECTDIR}/German_Address.o: German_Address.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/German_Address.o German_Address.cpp
...
${OBJECTDIR}/Student_Worker.o: Student_Worker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Student_Worker.o Student_Worker.cpp

${OBJECTDIR}/US_Address.o: US_Address.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/US_Address.o US_Address.cpp
